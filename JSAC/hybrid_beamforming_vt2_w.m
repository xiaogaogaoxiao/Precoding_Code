function [V_t,V_RF,V_D] = hybrid_beamforming_vt2_w(H,N_RF,V_RF,P,Nt,sigma2)
%À„∑®1 °∞[2]Hybrid Analog and Digital Beamforming for mmWave OFDM Large-Scale Antenna Arrays°±
    for j=1:N_RF
        V_RF1=V_RF;
        V_RF1(:,j)=[];
        F1=H'*H;
